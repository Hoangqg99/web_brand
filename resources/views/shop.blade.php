...
@section('content')
    <style>
        /* Định dạng cho các mục trong danh sách thương hiệu và danh sách thể loại */
        .brand-list li,
        .category-list li {
            line-height: 40px;
        }

        /* Định dạng cho các phần tử kiểm tra thương hiệu và thể loại */
                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="brands" value="{{ $brand->id }}"
                                                    class="chk-brand" @checked(in_array($brand->id, explode(',', $f_brands)))>
                                                {{ $brand->name }}
                                            </span>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            ...
                            <option value="4"{{ $order == 4 ? 'selected' : '' }}>Price, High To High</option>
                        </select>
                        ...
                        <div class="product-card-wrapper">
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    @if (Cart::instance('wishlist')->content()->where('id', $product->id)->isNotEmpty())
                                        <form
